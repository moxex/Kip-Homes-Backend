...
class PropertySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Property
        fields = ['id', 'user', 'profile_photo', 'title', 'slug', 'ref_code', 'description',
                    'country', 'city', 'postal_code', 'street_address', 'property_number',
                    'price', 'vat', 'final_property_price', 'plot_area', 'total_floors',
                    'bedrooms', 'bathrooms', 'advert_type', 'property_type', 'cover_photo',
